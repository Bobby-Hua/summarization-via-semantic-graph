...
class DoubleDataCollator:
    ...
    def __call__(self, features, return_tensors=None):
        ...
        features['amr_features']={'concept': amr_features[0],
         'concept_char': amr_features[1],
         'concept_depth': amr_features[2],
         'relation': amr_features[3],
         'relation_bank': amr_features[4],
         'relation_length': amr_features[5],
         'local_idx2token': amr_features[6],
         'local_token2idx': amr_features[7],
         'cp_seq': amr_features[8],
        'gold_node_tgt':amr_features[9]}
        return features
